...
db = connection2['july']
edge_collection = db['instagram_mentions']
out_collection = db['instagram_mentions_hop_analysis']
...
for name in cleanlist:    
    Onehop = extractKHopSocialNetworkSize('localhost', 'july_test','instagram_mentions',name, 1)
    Twohop = extractKHopSocialNetworkSize('localhost', 'july_test','instagram_mentions',name, 2)
